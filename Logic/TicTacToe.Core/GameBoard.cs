...
namespace NEUKO.TicTacToe.Core
{
    public class GameBoard : IGameBoard
    {
        ...
        public void CheckForWinner()
        {
            ...
            {
                if (i == 0)
                    CheckWinningConstellation(0, 1, 2);
                if (i == 1)
                    CheckWinningConstellation(3, 4, 5);
                if (i == 2)
                    CheckWinningConstellation(6, 7, 8);
                if (i == 3)
                    CheckWinningConstellation(0, 3, 6);
                if (i == 4)
                    CheckWinningConstellation(1, 4, 7);
                if (i == 5)
                    CheckWinningConstellation(2, 5, 8);
                if (i == 6)
                    CheckWinningConstellation(0, 4, 8);
                if (i == 7)
                    CheckWinningConstellation(2, 4, 6);
            }
        }

        private void CheckWinningConstellation(int idOne, int idTwo, int idThree)
        {
            Console.WriteLine("prüfe Constellation: " + idOne + idTwo + idThree);
            ...
            Console.WriteLine(actualSignes);
